...
\begin{instrumentationPicture}
  ...
  \begin{instrumentFamily}
    ...
    \begin{bracketedAmbitus}{Double Bass}
      \ambitusComponent[D.B. harmonics]{notes=40} \ambitusComponent{notes=45} \ambitusComponent{notes=47} \ambitusComponent{notes=50} \ambitus{notes={52, 84}, secondary-notes=89}
      \begin{compactAmbitus}
