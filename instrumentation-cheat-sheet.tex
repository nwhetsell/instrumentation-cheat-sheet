...
\begin{tikzpicture}[
  ...
  % The highest note is the D five half-steps above the 3,520 Hz A, so in most
  ...
  \foreach \frequency in {
      ...
      \pgfmathparse{
        89 * ln(\frequency / 27.5) / ln(\maxFrequency / 27.5) + 0.5
        % This is a simplification of
        %   (ln(\frequency) - ln(27.5)) * (89.5 - 0.5) / (ln(\maxFrequency) - ln(27.5)) + 0.5
      }
