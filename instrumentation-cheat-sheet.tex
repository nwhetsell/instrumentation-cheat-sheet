...
\begin{tikzpicture}[
  ...
  \def\separatedInstrumentCount{33}
...
\begin{multicols*}{3}
  ...
  \begin{tabular}[t]{@{}l>{\addfontfeature{Numbers={Lining,Monospaced}}}r>{\addfontfeature{Numbers={Lining,Monospaced}}}r>{\addfontfeature{Numbers={Lining,Monospaced}}}r@{}} \toprule
