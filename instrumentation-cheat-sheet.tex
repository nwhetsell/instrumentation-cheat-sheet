    ...
    \begin{scope}[
      ...
      \foreach \noteNumber in { 24, 36, ..., 108 } {
        ...
        \path
          ...
          node { C\octave };
        \ifnum\noteNumber>24\relax
          \path (\noteNumber - 21, -\noteGuideBottom - \keyboardYOffset) node[anchor=south west] { C\octave };
        \fi
      }
      ...
      \path
        ...
        node { A\octave }
        ++(0, -\noteGuideBottom - \noteGuideTop)
        node[anchor=south west] { A\octave };
    \end{scope}
...
\begin{multicols*}{4}
  ...
  \begin{tabular}[t]{@{}p{\instrumentWidth}RRR@{}} \toprule
    ...
    Saxophones          & \notecite[231]{adler} & \notecite[126]{blatter}                         & \notecite[166]{forsyth} \\ \bottomrule
  \end{tabular}
