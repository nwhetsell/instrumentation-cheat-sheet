  ...
  \NewDocumentCommand { \ambitusComponent } { o o m } {
    ...
    \begin{scope}[node~ distance=0]
      ...
      \begin{scope}[rounded~ corners=0.5bp]
        ...
        \node[note~ name] (\l_low_node_name_tl) at (\l_primary_note_start_int - 21, \ambitusMinY) {
        ...
        \bool_if:nT { \l_secondary_note_start_is_below_primary_bool } {
          \node[note~ name] (\l_low_node_name_tl) at (\l_secondary_note_start_int - 21, \ambitusMinY) {
            \noteName{\l_secondary_note_start_int}
          };
        }

        \node[note~ name] (\l_high_node_name_tl) at (\l_primary_note_end_int - 21, \ambitusMinY) {
        ...
        \bool_if:nT { \l_secondary_note_end_is_above_primary_bool } {
          \node[note~ name] (\l_high_node_name_tl) at (\l_secondary_note_end_int - 21, \ambitusMinY) {
