...
\begin{instrumentationPicture}
  ...
  \begin{scope}[yshift=\l_tmpb_dim - \l_ambitus_bar_height_tl cm]
    \begin{scope}[draw=black-key-color]
      % The outline of this path is drawn in the right margin by a miniscule
      % amount, causing an “Overfull \hbox” warning.
  ...
  \begin{scope}[on~ background~ layer]
    ...
    \fill[fill=white-note-guide-color]
      ...
      \l_tmpa_tl; % This causes a spurious “Overfull \hbox” warning.
