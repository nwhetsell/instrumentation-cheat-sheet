...
\begin{instrumentationPicture}
  ...
  \begin{scope}[on~ background~ layer]
    ...
    \tl_set:Nn \l_tmpa_tl
      {
                              rectangle ++(1, -\l_bottom_y_tl) % A
        ++(1, \l_bottom_y_tl) rectangle ++(1, -\l_bottom_y_tl) % B
        ++(2, \l_bottom_y_tl) rectangle ++(1, -\l_bottom_y_tl) % D
      }
    ...
    \fill[fill=white-note-guide-color]
      ...
      \foreach \octave in { \l_first_octave_int, ..., \l_last_octave_int } {
        \l_tmpa_tl
        ++(1,              \l_bottom_y_tl) rectangle ++(1 - \l_tmpb_tl, -\l_bottom_y_tl) % E
        ++(2 * \l_tmpb_tl, \l_bottom_y_tl) rectangle ++(1 - \l_tmpb_tl, -\l_bottom_y_tl) % F
        ++(1,              \l_bottom_y_tl) rectangle ++(1,              -\l_bottom_y_tl) % G
        ++(1,              \l_bottom_y_tl)
      }
      \l_tmpa_tl;
    ...
    \tl_set:Nn \l_tmpa_tl
      {
                              rectangle ++(1, -\l_bottom_y_tl) % A♯/B♭
        ++(2, \l_bottom_y_tl) rectangle ++(1, -\l_bottom_y_tl) % C♯/D♭
      }
    ...
    \fill[fill=black-note-guide-color]
      ...
      \foreach \octave in { \l_first_octave_int, ..., \l_last_octave_int } {
        \l_tmpa_tl
        ++(1, \l_bottom_y_tl) rectangle ++(1, -\l_bottom_y_tl) % D♯/E♭
        ++(2, \l_bottom_y_tl) rectangle ++(1, -\l_bottom_y_tl) % F♯/G♭
        ++(1, \l_bottom_y_tl) rectangle ++(1, -\l_bottom_y_tl) % G♯/A♭
        ++(1, \l_bottom_y_tl)
      }
      \l_tmpa_tl;
  \end{scope}
