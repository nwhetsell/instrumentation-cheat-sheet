...
\NewDocumentCommand { \labelCsAndConcertPitch } { o }
  {
    ...
    \begin{scope}[
      ...
      \foreach \noteNumber in { 24, 36, ..., 108, 69 } {
        \tl_set:Nn \l_tmpa_tl { \noteOctave{\noteNumber} }
        \bool_if:nT { \int_compare_p:nNn \l_tmpa_tl > \l_labeled_note_minimum_octave_int } {
          \node at (\noteNumber - 21, 0) {
            \pitchClass{\noteNumber}\l_tmpa_tl
          };
        }
...
\begin{instrumentationPicture}
  ...
  \pgfgetlastxy{\l_tmpa_dim}{\l_tmpb_dim}
  \tl_gset:Nx \g_ambitus_y_tl { \dim_to_decimal_in_cm:n { -\l_tmpb_dim } - 2 * \l_ambitus_bar_height_tl }
