...
\begin{tikzpicture}[
  ...
  \begin{scope}[
    ...
    \begin{instrumentFamily}
      ...
      \begin{bracketedAmbitus}{Cello}
        ...
        \path
          ...
          at (96.5 - 21, \y1 + 0.5*\ambitusBarHeight cm) {
    ...
    \begin{instrumentFamily}
      ...
      \path
        ...
        node[annotation, anchor=mid west, text width=14.5*\blackKeyWidth]
        at (\x1 + \blackKeyWidth, \y1 + \ambitusBarHeight cm) {
  ...
  \input .midpoints
  \pgfmathsetmacro{\scaleFactor}{(87 * \blackKeyWidth) / (\maxNoteMidpoint - \minNoteMidpoint)}
  \path
    let \p1=(Piccolo-high) in
    (0.5 * \blackKeyWidth - \minNoteMidpoint * \scaleFactor, 0)
    node[anchor=north west] {
      \includegraphics[scale=\scaleFactor]{notes-bottom.pdf}
    }
    ++(0, \y1 - \ambitusBarHeight cm)
    node[anchor=south west] {
      \includegraphics[scale=\scaleFactor, trim={0 108bp 0 0}, clip]{notes-top.pdf}
    };
\end{tikzpicture}
