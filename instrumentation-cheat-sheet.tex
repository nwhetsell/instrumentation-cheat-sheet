...
\begin{tikzpicture}[
  ...
  \pgfmathsetmacro{\maxFrequency}{4698.6362866785} % 3520 * pow(2, 5/12)
  ...
  \foreach \frequency in {
      ...
      \pgfmathparse{(log10(\frequency) - log10(27.5)) * (89.5 - 0.5) / (log10(\maxFrequency) - log10(27.5)) + 0.5}
      \draw[c-label-color] (\pgfmathresult, -\noteGuideBottom) -- ++(0, -0.05) node[anchor=north,yshift=-0.2ex] {
  ...
  \begin{scope}[
    ...
    \begin{instrumentFamily}
      ...
      \drawPrimaryAmbitus{35}{72}[B♭ Euphonium]
      \drawPrimaryAmbitus{40}{72}[B♭ Baritone]
      ...
      \drawPrimaryAmbitus{40}{72}[B♭ Bass Trumpet]
